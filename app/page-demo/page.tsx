            ...
            <div className="card-body border-top p-9">
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="image-input image-input-outline" data-kt-image-input="true" style={{ backgroundImage: "url('assets/media/svg/avatars/blank.svg')"}}>
                            ...
                            <label className="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                ...
                                <input type="file" className="avatar" accept=".png, .jpg, .jpeg" />
                                <input type="hidden" className="avatar_remove" />
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 fv-row">
                                <input type="text" className="fname" className="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="Max" />
                            </div>
                            
                            
                            <div className="col-lg-6 fv-row">
                                <input type="text" className="lname" className="form-control form-control-lg form-control-solid" placeholder="Last name" value="Smith" />
                            </div>
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        <input type="text" className="company" className="form-control form-control-lg form-control-solid" placeholder="Company name" value="Keenthemes" />
                    </div>
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        <input type="tel" className="phone" className="form-control form-control-lg form-control-solid" placeholder="Phone number" value="044 3276 454 935" />
                    </div>
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        <input type="text" className="website" className="form-control form-control-lg form-control-solid" placeholder="Company website" value="keenthemes.com" />
                    </div>
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        <select className="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." className="form-select form-select-solid form-select-lg fw-semibold">
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        ...
                        <select className="language" aria-label="Select a Language" data-control="select2" data-placeholder="Select a language..." className="form-select form-select-solid form-select-lg">
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        <select className="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select a timezone.." className="form-select form-select-solid form-select-lg">
                ...
                <div className="row mb-6">
                    ...
                    <div className="col-lg-8 fv-row">
                        <select className="currnecy" aria-label="Select a Currency" data-control="select2" data-placeholder="Select a currency.." className="form-select form-select-solid form-select-lg">
                    ...
                    <div className="col-lg-8 fv-row">
                        ...
                        <div className="d-flex align-items-center mt-3">
                            ...
                            <label className="form-check form-check-custom form-check-inline form-check-solid me-5">
                                <input className="form-check-input" className="communication[]" type="checkbox" value="1" />
                            ...
                            <label className="form-check form-check-custom form-check-inline form-check-solid">
                                <input className="form-check-input" className="communication[]" type="checkbox" value="2" />
                ...
                <div className="row mb-0">
                    ...
                    <div className="col-lg-8 d-flex align-items-center">
                        <div className="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input className="form-check-input w-45px h-30px" type="checkbox" id="allowmarketing" checked="checked" />
